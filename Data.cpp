//aqui no data.cpp temos a logica para Ler uma instância do TSP com as funções e dados do data.h
// e transformar os dados do arquivo em estruturas que o restante do programa consegue usar
#include "Data.h"//para usar as declarações que estao no arquivo data.h


//Inicializador
Data::Data( int qtParam, char * instance )://é o contrutor da classe que basicamente permite a inicialização de objetos criados da classe data
//diz que eles começam vazios, pega as coordenadas x, a y e a distancia para matriz
xCoord(NULL),
yCoord(NULL),
distMatrix(NULL){
